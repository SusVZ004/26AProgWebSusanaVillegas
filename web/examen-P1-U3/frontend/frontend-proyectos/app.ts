...
const form = document.getElementById("form-proyecto") as HTMLFormElement;
const lista = document.getElementById("lista-proyectos") as HTMLUListElement;
...
form.addEventListener("submit", async (e: Event) => {
    ...
    const nombreInput = document.getElementById("nombreProyecto") as HTMLInputElement;
    const descInput = document.getElementById("descripcionProyecto") as HTMLInputElement;
